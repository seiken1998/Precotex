...
export class DefectosAlmacenDerivadosService {
  ...
  Cf_Enviar_Alerta_Audita_Defectos_Derivados_Telegram(Cod_Cliente: string, Nom_Cliente: string,Cod_EstCli: string, Cod_TemCli: string, Nom_TemCli: string,Cod_ColCli: string, Total_Num_Prenreq: number, Total_Num_Defecto: number, Total_Num_Caidas: number){
    return this.http.get(`${this.baseUrl}/app_Cf_Enviar_Alerta_Audita_Defectos_Derivados_Telegram.php?Cod_Cliente=${Cod_Cliente}&Nom_Cliente=${Nom_Cliente}&Cod_EstCli=${Cod_EstCli}&Cod_TemCli=${Cod_TemCli}&Nom_TemCli=${Nom_TemCli}&Cod_ColCli=${Cod_ColCli}&Total_Num_Prenreq=${Total_Num_Prenreq}&Total_Num_Defecto=${Total_Num_Defecto}&Total_Num_Caidas=${Total_Num_Caidas}`);
  }
